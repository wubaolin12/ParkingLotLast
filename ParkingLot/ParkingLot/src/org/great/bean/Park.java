...
public class Park {
	...
	public Park(int pm_id, String p_fore, int p_num, String p_state, String p_mapid, int p_feum) {
		super();
		this.pm_id = pm_id;
		this.p_fore = p_fore;
		this.p_num = p_num;
	...
	public Park(int p_id, int pm_id, int c_id, String p_fore, int p_num, String p_state, String p_mapid,
			String p_imgpath, Car car, Param param, String c_num) {
		super();
		this.p_id = p_id;
		this.pm_id = pm_id;
		this.c_id = c_id;
	...
	public Park(int p_id, int pm_id, int c_id, String p_fore, int p_num, String p_state, String p_mapid,
			String p_imgpath, int p_feum, Car car, Param param, String c_num) {
		super();
		this.p_id = p_id;
		this.pm_id = pm_id;
		this.c_id = c_id;
	...
	public int getP_feum() {
		return p_feum;
	}

	public void setP_feum(int p_feum) {
		this.p_feum = p_feum;
	}
	...
	public String toString() {
		return "Park [p_id=" + p_id + ", pm_id=" + pm_id + ", c_id=" + c_id + ", p_fore=" + p_fore + ", p_num=" + p_num
				+ ", p_state=" + p_state + ", p_mapid=" + p_mapid + ", p_imgpath=" + p_imgpath + ", p_feum=" + p_feum
				+ ", car=" + car + ", param=" + param + ", c_num=" + c_num + "]";
	}
