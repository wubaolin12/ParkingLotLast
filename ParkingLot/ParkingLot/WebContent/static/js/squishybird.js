...
for (var i = 1; i<=3; i++) {
 var o = {};
 var img = loadGameImage('../static/img/bird'+i+'.png');
 o.img = img;
 bird_images.push(o);

 var o = {};
 var img = loadGameImage('../static/img/angrybird'+i+'.png');
 o.img = img;
...
var flap = loadGameSound('../static/re/flap.wav', 5);
var pipeslide = loadGameSound('../static/re/slide.wav', 3);
var clang = loadGameSound('../static/re/clang.wav', 3);

var coin1 = loadGameSound('../static/re/coin.wav', 3);
var coin2 = loadGameSound('../static/re/coin2.wav', 3);
var coin3 = loadGameSound('../static/re/coin3.wav', 3);
var coin4 = loadGameSound('../static/re/coin4.wav', 3);

var kick = loadGameSound('../static/re/kick.wav', 5);
var kick2 = loadGameSound('../static/re/kick2.wav', 5);
var kick3 = loadGameSound('../static/re/kick3.wav', 5);
var kick4 = loadGameSound('../static/re/kick4.wav', 5);
var kick5 = loadGameSound('../static/re/kick5.wav', 5);

var kicks = [kick, kick2, kick3, kick4, kick5];

var squish1 = loadGameSound('../static/re/squish1.wav', 3);
var squish2 = loadGameSound('../static/re/squish2.wav', 3);
...
logo.showing = true;
logo.hiding = false;
logo.img = loadGameImage('../static/img/logo.png'); // 626 x 144
...
gameover.showing = false;
gameover.hiding = true;
gameover.img = loadGameImage('../static/img/gameover.png'); // 626 x 144
...
playagain.showing = false;
playagain.hiding = true;
playagain.img = loadGameImage('../static/img/playagain.png');
...
c2s.showing = true;
c2s.hiding = false;
c2s.img = loadGameImage('../static/img/clicktostart.png'); // 337 x 75
...
ground.bit = loadGameImage('../static/img/ground.png');
...
city.bit = loadGameImage('../static/img/city.png');
...
trees.bit = loadGameImage('../static/img/trees.png');
...
var blood_image = loadGameImage('../static/img/blood.png');
var bloods = [];
...
var pipe1 = {};
pipe1.img = loadGameImage('../static/img/pipe1.png');
pipe1.img.width = 148;
...
var pipe2 = {};
pipe2.img = loadGameImage('../static/img/pipe2.png');
pipe2.img.width = 148;
