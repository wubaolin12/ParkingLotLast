...
<![endif]-->
<title>月缴套餐数据统计</title>
</head>
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 收支管理 <span class="c-gray en">&gt;</span> 月缴套餐统计<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div class="text-c"> 
		<button type="submit" class="btn btn-success radius" id="" name="" onclick= "javascript :history.back(-1);"><i class="Hui-iconfont">&#xe665;</i> 返回</button>
	</div>
...
$(function () {
    $('#container').highcharts({
        ...
        series: [{
            ...
            name: 'Browser share',
            data: [
                ['套餐1',   ${dataStatistics.temporaryUserInCome1}],
                ['套餐2',       ${dataStatistics.temporaryUserInCome2}],
                {
                    name: '套餐3',
                    y: ${dataStatistics.temporaryUserInCome3},
                    sliced: true,
                    selected: true
                },
                ['套餐四',     ${dataStatistics.temporaryUserInCome4}],
            ]
        }]
    });
});
