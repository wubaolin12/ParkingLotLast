	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<c:forEach items="${mlist}" var="ul" varStatus="uu">
			<tr class="text-c">
				...
				<a title="编辑" href="javascript:;" onclick="admin_edit('菜单编辑','${path}menumanage/toUpdateMenu.action','${ul.menu_id}','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
