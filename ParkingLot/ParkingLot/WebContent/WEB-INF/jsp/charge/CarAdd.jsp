	...
	<article class="page-container">
		<form class="form form-horizontal" id="form-admin-add">
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="" placeholder=""
						id="cust_phone" name="cust_phone"> <label id="phoneFlag"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="" placeholder=""
						id="carnum" name="carnum"> <label id="carNumFlag"
						style="color: red"></label>
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<div class="radio-box">
						<input name="pm_id" type="radio" value="注册会员" id="pm_id"
							onclick="chose()" checked> <label for="sex-1">注册会员</label>
					</div>
					<input type="radio" id="pm_id" name="pm_id" value="包月会员"
						onclick="chose()"> <label for="sex-2">包月套餐</label>
				</div>
				<div class="radio-box">
					<span class="select-box" id="vipchose"
						style="width: 150px; visibility: hidden;"> <select
						class="select" name="adminRole" id="adminRole">
