...
<body>
<div id="img-upload" class="page-container" style="display:none">
	<form action="${path}/upload/save.action" class="form form-horizontal" id="form-article-add" method="post">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>车位号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<label id="parkLocal" class="form-label col-xs-4 col-sm-2" ></label>
				<input type="hidden" class="hidden-text" id="p_id" name="p_id">
				<input type="hidden" class="hidden-text" id="p_imgpath" name="p_imgpath">
			</div>
		</div>
				...
				<div class="uploader-list-container"> 
					...
					<div class="statusBar" style="display:none;">
						...
						<div class="btns">
							...
							<div id="startUpload"class="uploadBtn">开始上传</div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button id="submit"
					class="btn btn-primary radius" type="submit" style="display: none">
...
$(function(){
	...
	var uploader = WebUploader.create({
		...
		// 文件接收服务端。'lib/webuploader/0.1.5/server/fileupload.php'
		server: '${path}/upload/picture.action',
...
<script type="text/javascript" src="${path}/static/lib/webuploader/0.1.5/image-upload/upload.js"></script> 
</body>
</html>