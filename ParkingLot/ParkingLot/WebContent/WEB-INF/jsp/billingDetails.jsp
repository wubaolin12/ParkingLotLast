...
<form action="${path}/billingDetails/conditionQuery.action">
	<div class="text-c"> 日期范围：
		<input type="text" onfocus="WdatePicker({ maxDate:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}' })" id="datemin" name="datemin" class=" " style="width:120px;">
		-
		<input type="text" onfocus="WdatePicker({ minDate:'#F{$dp.$D(\'datemin\')}',maxDate:'%y-%M-%d' })" id="datemax" name="datemax" class="input-text Wdate" style="width:120px;">
		<input type="text" class="input-text" style="width:250px" placeholder="输入车牌号" id="carNum" name="carNum">
		<button type="submit" class="btn btn-success radius" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 搜车辆</button>
	</div>
</form>	
	
	
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="${path}/export/excel.action" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 导出昨日收支明细</a> <a href="javascript:;" onclick="member_add('数据统计','${path}/billingDetails/DataStatistics.action','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 数据统计</a>  <a href="javascript:;" onclick="javascript:location.href='${path}/billingDetails/jumpChart.action'" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 套餐图表统计</a></span>  </div>
	<div class="mt-20">
