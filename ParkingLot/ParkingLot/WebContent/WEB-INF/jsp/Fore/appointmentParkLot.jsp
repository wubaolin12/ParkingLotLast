...
<!-- CSS -->
<link rel="stylesheet"
	href="${path}/static/fore-static/css/bootstrap.css" type="text/css"
	media="screen">
<link rel="stylesheet"
	href="${path}/static/fore-static/css/bootstrap-responsive.css"
	type="text/css" media="screen">
<link rel="stylesheet" href="${path}/static/fore-static/css/style.css"
	type="text/css" media="screen">
<link rel="stylesheet"
	href="${path}/static/fore-static/css/font-awesome.css" type="text/css"
	media="screen">
<!--[if lt IE 8]>
	...
	<div class="mountainbg">
		<div class="mountaincover">
			...
			<div class="hot-air-balloon">
				<img src="${path}/static/fore-static/images/bicycle.png" alt="">
			</div>
		</div>
	</div>
	<!-- END MOUNTAIN EFFECT -->
					...
					<div class="span8 offset1">
						...
						<div class="box2 ">
							<div class="caroufredsel_slider1_wrapper">
								<a class="prev1" href="index.html#"></a> <a class="next1"
									href="index.html#"></a>
								<ul id="caroufredsel_slider1" class="clearfix">
									<li>
										<div class="caroufredsel_slide1">
											<img src="${path}/static/fore-static/images/slider/遮车布.PNG"
												alt="Slider2" class="img">
											<div class="txt1">办理三个月以上套餐送遮车布</div>
										</div>
									</li>
									<li>
										<div class="caroufredsel_slide1">
											<img src="${path}/static/fore-static/images/slider/摇头狗.PNG"
												alt="Slider2" class="img"
												onclick="window.open('https://detail.tmall.com/item.htm?spm=a230r.1.14.22.69ae651e0tKjc1&id=584172873947&ns=1&abbucket=15')">
											<div class="txt1"
												onclick="window.open('https://detail.tmall.com/item.htm?spm=a230r.1.14.22.69ae651e0tKjc1&id=584172873947&ns=1&abbucket=15')">淘宝广告：卖萌摇头狗</div>
										</div>
									</li>
...
<div class="pages">
									...
									<div>
										<select class="select" name="c_id" id="c_id">
											<c:forEach items="${CustCarList}" var="c" varStatus="cc">
												<option value="${c.c_id}">${c.c_num}</option>
											</c:forEach>
										</select>
									</div>
									<div>
	...
	<script type="text/javascript"
		src="${path}/static/fore-static/js/jquery.easing.1.3.js"></script>
	<script type="text/javascript"
		src="${path}/static/fore-static/js/superfish.js"></script>
	<script type="text/javascript"
		src="${path}/static/fore-static/js/jquery.ui.totop.js"></script>
	<script type="text/javascript"
		src="${path}/static/fore-static/js/jquery.caroufredsel.js"></script>
	<script type="text/javascript"
		src="${path}/static/fore-static/js/jquery.touchSwipe.min.js"></script>
	<script type="text/javascript"
