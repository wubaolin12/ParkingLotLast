...
<body>
	<article class="page-container">
		<form class="form form-horizontal" id="form-admin-add"  action="<%=path%>park/updatePark.action" onSubmit="return nonull()">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">区号:</span></label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${updatePark.p_fore}" placeholder=""
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${updatePark.p_num}" placeholder=""
						id="p_num" name="p_num">
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="${updatePark.p_mapid}" placeholder=""
						id="p_mapid" name="p_mapid">
							<input type="hidden" class="input-text" value="${updatePark.p_id}" placeholder=""
						id="p_id" name="p_id">
				</div>
			</div>
