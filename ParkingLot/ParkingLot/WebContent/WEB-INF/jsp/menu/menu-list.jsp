...
<!-- 	<form action="seachmenuList.action">
	...
	<a href="javascript:;" onclick="member_add('添加菜单','toInsertMenu.action','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加菜单</a></span> </div>
	<div class="mt-20">
...
function member_add(title,url,w,h){
	/* layer_show(title,url,w,h); */
	  parent.layer.open({
	        ...
	        maxmin: true,
	        closeBtn: 1,
	         content: '${path}/menumanage/toInsertMenu.action',  //iframe的url，yes是否有滚动条
	        end: function () {
